...
Lemma constantfold_value_correct :
...
Lemma constantfold_jump_correct :
  forall cfg bn e_start e_end ps q k,
    jump cfg bn e_start e_end ps q k = jump (fold_controlflowgraph cfg) bn e_start e_end (fold_phis ps) q k.
Proof.  intros. induction ps; eauto. 