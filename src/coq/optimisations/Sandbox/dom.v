...
Module Type GRAPH.
  ...
  Parameter Inline entry : t -> option V.
...
Definition entry_pc (g:G.t) := forall ent, entry g = Some ent.



  Definition Dom (g:G.t) (b v1 v2: V) : Prop :=
    forall vs, Path g b v2 vs -> In v1 vs.

  Definition SDom (g:G.t) (b v1 v2 : V) : Prop :=
    v1 <> v2 /\ Dom g b v1 v2.

  Definition IDom (g:G.t) (b v1 v2 : V) : Prop :=
    SDom g b v1 v2 /\ forall v3, SDom g b v3 v2 -> Dom g b v3 v1.

  Definition reachable (g:G.t) (b v : V) : Prop :=
    exists p, Path g b v p.


  Lemma start_in_path: forall (g:G.t) (v1 v2 : V) p,
      Path g v1 v2 p -> In v1 p.
  Proof.
    intros g v1 v2 p H. induction H.
    +unfold In. eauto.
    +simpl in *. right. apply IHPath. Qed.
  ...
  Qed.        
    ...
    Lemma Dom_reflexive : forall (g:G.t) (b v : V),
      Dom g b v v.
  Proof.
    intros g b v.
    unfold Dom.
  ...
  Lemma Dom_antisymmetric : forall (g:G.t) (b v1 v2 : V),
      reachable g b v1 -> 
      Dom g b v1 v2 -> Dom g b v2 v1 -> v1 = v2.
  Proof.
    intros g b v1 v2 H1 D1 D2.
    unfold Dom in *.
    destruct H1 as [p Hp].
    assert (In v1 p). eapply end_in_path. apply Hp.
    destruct (acyclic_path_exists g b v1 v1 p Hp H) as [p' [Hp' Hin]].
    assert (In v2 (v1 :: p')) as Hin'. eapply D2. apply Hp'.
    destruct (path_splits g b v1 v2 (v1::p') Hp' Hin') as [q1 [q2 [HQ1 [HQ2 Heq]]]].
  ...
  Lemma Dom_transitive : forall (g:G.t) (b v1 v2 v3 : V),
      Dom g b v1 v2 -> Dom g b v2 v3 -> Dom g b v1 v3.
  Proof.
    intros g b v1 v2 v3 D1 D2.
    unfold Dom in *.
    intros vs Hp.
    destruct (path_splits g b v3 v2 vs) as [q1 [q2 [HQ1 [HQ2 Heq]]]]; auto. 
    apply D1 in HQ1.
    inversion HQ1.
  ...
  Lemma IDom_unique : forall (g:G.t) (b v1 v2 v : V),
      reachable g b v1 ->
      IDom g b v1 v -> IDom g b v2 v -> v1 = v2.
  Proof.
    intros g b v1 v2 v H H1 H2.
  ...
  Lemma dom_step : forall g b v1 v2,
    mem g v2 -> edge g v1 v2 -> forall v', SDom g b v' v2 -> Dom g b v' v1.
  Proof.
    unfold SDom, Dom. intros g b v1 v2 Hmem Hsucc v' [Hneq Hdom] p Hp.
...
Module Type Algdom (Import G:GRAPH).
  ...
  Axiom entry_sound : forall g b sdom,
  ...
  Axiom complete : forall g b sdom n1 n2,
    calc_sdom g = Some sdom ->
    SDom g b n1 n2 -> L.In n1 (sdom n2).
...
Module AlgdomProperties (Import G:GRAPH) (Import A : Algdom G).
  ...
  Lemma sound : forall g b sdom n1 n2,
    calc_sdom g = Some sdom ->              
    L.In n1 (sdom n2) -> Dom g b n1 n2.
  Proof.
    red; intros. remember b. induction H1. subst.
    pose proof entry_sound g b sdom H. 

    destruct (sdom b); try contradiction; simpl in *.
